%toString Relation Any String;instantied Relation Any;type Relation Any Any;throw Relation Any;iterate Relation Relation Integer Any Any;applyCatch Relation Relation Functor Relation;applyOnce Relation Relation Functor;apply Relation Relation Functor;between Relation Any Any Any;listOf Relation Any Relation Any Functor
...
logic_env(X) :- new(X0),set(X0,"toString",logic_toString,X1),set(X1,"instantied",logic_instantied,X2),set(X2,"type",logic_type,X3),set(X3,"throw",logic_throw,X4),set(X4,"iterate",logic_iterate,X5),set(X5,"applyCatch",logic_applyCatch,X6),set(X6,"applyOnce",logic_applyOnce,X7),set(X7,"apply",logic_apply,X8),set(X8,"between",logic_between,X9),set(X9,"listOf",logic_listOf,X10),math_env(Y10),set(X10,"math",Y10,X11),string_env(Y11),set(X11,"string",Y11,X12),list_env(Y12),set(X12,"list",Y12,X13),set(X13,"Some",logic_Some,X14),set(X14,"None",logic_None,X15),set(X15,"Left",logic_Left,X16),set(X16,"Right",logic_Right,X17),X=X17.