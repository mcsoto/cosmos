%reverse Relation Functor Functor;fold Relation Functor (Relation Any Any Any) Any Any;join Relation Functor String String;filter Relation Functor (Relation Any) Functor;every Relation Functor (Relation Any);each Relation Functor (Relation Integer Any Any) Functor;eachIndex Relation Any Any Any Any;map Relation Functor (Relation Any Any) Functor;concat Relation Functor Functor Functor;has Relation Functor Any;find Relation Functor Any Integer;slice Relation Functor Integer Integer Functor;pop Relation Functor Functor;push Relation Functor Any Functor;last Relation Functor Any;size Relation Functor Integer;rest Relation Functor Any;first Relation Functor Any;get Relation Functor Integer Any
...
list_env(X) :- new(X0),set(X0,"reverse",list_reverse,X1),set(X1,"fold",list_fold,X2),set(X2,"join",list_join,X3),set(X3,"filter",list_filter,X4),set(X4,"every",list_every,X5),set(X5,"each",list_each,X6),set(X6,"eachIndex",list_eachIndex,X7),set(X7,"map",list_map,X8),set(X8,"concat",list_concat,X9),set(X9,"has",list_has,X10),set(X10,"find",list_find,X11),set(X11,"slice",list_slice,X12),set(X12,"pop",list_pop,X13),set(X13,"push",list_push,X14),set(X14,"last",list_last,X15),set(X15,"size",list_size,X16),set(X16,"rest",list_rest,X17),set(X17,"first",list_first,X18),set(X18,"get",list_get,X19),string_env(Y19),set(X19,"string",Y19,X20),set(X20,"Some",list_Some,X21),set(X21,"None",list_None,X22),set(X22,"Left",list_Left,X23),set(X23,"Right",list_Right,X24),X=X24.